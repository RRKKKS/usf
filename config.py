...
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [5345637082] + [5762071510]
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
OWNER = getenv("OWNER", None)

UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/dadtgq/usf/")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/21d8d09bfe13ffd721b65.jpg")
