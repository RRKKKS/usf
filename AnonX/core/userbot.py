...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.two.join_chat("R_N_B1")
                await self.two.join_chat("RB900")
                await self.two.join_chat("RR_BU")
                await self.two.join_chat("RB_2222")
                await self.two.join_chat("SOURCE_NEON")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("R_N_B1")
                await self.three.join_chat("SOURCE_NEON")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("R_N_B1")
                await self.four.join_chat("SOURCE_NEON")
            except:
                pass
            assistants.append(4)
