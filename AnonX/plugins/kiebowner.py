...
@app.on_message(command(["/vo", "✭ رجوع"]) & SUDOERS)
...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/R_R_B0",
        caption=f"""[ َِ.𝘀𝗼𝘂𝗿𝗰𝗲 NEON.〙𝘁𝗵𝗲 𝗳 𝗶𝗿𝘀𝘁 𝗰𝗵𝗲𝗿𝘂𝗯 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝗽𝗲𝗼𝗽𝗹𝗲 𝗳𝗼𝗹𝗹𝗼𝘄𝗲𝗱 𝗵 𝗶𝘀 𝗸𝗶𝗻𝗴𝘀 𝗮𝗻𝗱 𝗿𝗮𝗻𝗸 𖥳𝗰𝗿𝗲𝗮𝘁𝗼𝗿𝘀 𝗼𝗳 𝗽𝘂𝘀𝗵𝗰𝗵𝗲𝗻𝗸𝘆♬♪](https://t.me/SOURCE_NEON)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩 🔻︙قـنـاة الـسـورس︙🔺️ 𓆪", url=f"https://t.me/SOURCE_NEON"),
            ]
         ]
     )
  )
...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/R_R_B0",
        caption=f"""[THIS DEV MAIN SOURCE NEON ](https://t.me/R_R_B0)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩 🔻︙قـنـاة الـسـورس︙🔺️ 𓆪", url=f"https://t.me/SOURCE_NEON"),
...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/SOURCE_NEON",
        caption=f"""[لـطـلـب ســورس مـيـوزك خـاص بــك او مــيـزه في ســورس مـيـوزك لا تـتـردد فـي الـتـواصـل مـعـي مـن خـلال الـزر فـي الأسـفـل ♬♪](https://t.me/SOURCE_NEON)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩🔻︙قـنـاة الـسـورس︙🔺️ 𓆪", url=f"https://t.me/SOURCE_NEON"),
                InlineKeyboardButton("𓆩👨‍💻︙مطور الـسـورس 𓆪", url=f"https://t.me/R_R_B0"),
            ]
         ]
     )
  )
...
def reply_to_HEY(Client, message):
    message.reply_photo(
        photo=f"https://t.me/R_R_B0",
        caption=f"""[مطور السورس](https://t.me/R_R_B0)""",
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("𓆩👨‍💻︙مطور الـسـورس 𓆪", url=f"https://t.me/R_R_B0"),
            ...
            [
                [
                    InlineKeyboardButton(
                        "⸢ 𝐍𝐄𝐎𝐍 𝐒𝐎𝐔𝐑𝐂𝐄 ⸥", url=f"https://t.me/SOURCE_NEON"),
                ],
            ]
        ),
    )
...
@app.on_message(
    command(["دادي","الداد","الباشا","مبرمج","NEON","صاحب السورس","المطور","مطور"])
    & filters.group
    & ~filters.edited
)
...
@app.on_message(
    command(["سوس","سوستي","الباشا","مبرمج","NEON","صاحب السورس","المطور","مطور"])
    & filters.group
    & ~filters.edited
)
async def yas(client, message):
    ...
    async for photo in client.iter_profile_photos(message.from_user.id, limit=1):
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "⸢ 𝑽𝑬𝑵𝑶𝑴 • 𝙎𝙊𝙐𝙍𝘾𝙀 ⸥", url=f"https://t.me/RB_RO"),
                ],
            ]
        ),
    )
...
@app.on_message(filters.regex("༺┉⊶﴿♡  NEON ĶËŸBÖÄŖĐ ♡﴾⊷┉༻") & filters.private & SUDOERS)
async def italy(client: Client, message: Message):
    usr = await client.get_users(message.from_user.id)
    name = usr.first_name
    async for photo in client.iter_profile_photos(message.from_user.id, limit=1):
                    await message.reply_text( 
                    f"""**نبذه سريعه عن** NEON ĶËŸBÖÄŖĐ **: **ماهو بيتا كيبورد🤔** **هو اصدار اولي قابل لتعديل في اي وقت قابل الاضافة مميزات واضافة جديد في اي وقت بي اختصار قابل لتحديث ولاضافه في اي وقت**🫡""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
